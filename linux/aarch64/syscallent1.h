	...
	{ 1,	TP|CE,	sys_exit,			"exit"				}, /*   93 */
	{ 1,	TP|CE,	sys_exit,			"exit_group"			}, /*   94 */
	...
	{ 4,	TI|CI,	sys_shmat,			"shmat"				}, /*  196 */
	{ 4,	TI|CI,	sys_shmdt,			"shmdt"				}, /*  197 */
	...
	{ 5,	TM|CI,	sys_remap_file_pages,		"remap_file_pages"		}, /*  234 */
