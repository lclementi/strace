	...
	{ 3,	TF|TP|CI|CE,sys_execve,		"execve"	}, /* 117 */
	{ 1,	TP|CE,	sys_exit,		"exit"		}, /* 118 */
	{ 1,	TP|CE,	sys_exit,		"exit_group"	}, /* 119 */
	...
	{ 5,	TM|CI,	sys_remap_file_pages,	"remap_file_pages"}, /* 261 */
