 ...
 */
	...
	{ 6,	TD|TM|CI,sys_mmap_4koff,	"mmap2"			}, /* 89 */
	{ 6,	TD|TM|CI,sys_mmap,		"mmap"			}, /* 90 */
	...
	{ 3,	TI|CI,	sys_shmat,		"shmat"			}, /* 192 */
	{ 1,	TI|CI,	sys_shmdt,		"shmdt"			}, /* 193 */
	...
	{ 1,	TP|CE,	sys_exit,		"exit_group"		}, /* 222 */
	...
	{ 5,	TM|CI,	printargs,		"remap_file_pages"	}, /* 227 */
