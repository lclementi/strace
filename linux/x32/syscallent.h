	...
	{ 3,	TF|TP|CI|CE,printargs,		"64:execve"	},  /* 60 */
	{ 1,	TP|CE,	sys_exit,		"_exit"		},  /* 60 */
	...
	{ 1,	TP|CE,	sys_exit,		"exit_group"	}, /* 231 */
	...
	{ 3,	TF|TP|CI|CE,sys_execve,		"execve"	},  /* 520 */
